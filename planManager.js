...
const BYPASS_BILLING = {
  ...
  // Boutique de test - acces Business gratuit
  "bulk-stock-manager-2.myshopify.com": "business",
...
const PLANS = {
  ...
  pro: {
    ...
    features: [
      "75 produits",
      "Tout Starter +",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã‚Â¦ Lots / DLC / Tracabilite",
      "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Â­ Analytics fournisseurs",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“ââ‚¬Â¹ Inventaire physique",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã…Â  Analytics (CA, marges)",
      "ÃƒÂ°Ã…Â¸ââ‚¬Âââ‚¬Â Notifications Slack/Discord",
      "ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â Gestion freebies",
      "Historique 90 jours",
    ],
    cta: "Choisir Pro",
  },
  ...
  business: {
    ...
    features: [
      "Produits illimites",
      "Tout Pro +",
      "ÃƒÂ°Ã…Â¸ââ‚¬ÂÃ‚Â® Previsions de rupture (IA)",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã‚Â¦ Kits / Bundles / Composes",
      "ÃƒÂ°Ã…Â¸Ã‚Â§Ã‚Â¾ Bons de commande (PO)",
      "ÃƒÂ°Ã…Â¸ââ‚¬ËœÃ‚Â¥ Multi-utilisateurs (5)",
      "âÃ…Â¡Ã‚Â¡ Automatisations",
      "ÃƒÂ°Ã…Â¸ââ‚¬Âââ‚¬â€ Integrations (Zapier)",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã‚Â§ Rapports auto par email",
      "âÃ‚Â­Ã‚Â Support prioritaire",
      "Historique 1 an",
    ],
  ...
  enterprise: {
    ...
    features: [
      "Tout Business +",
      "ÃƒÂ°Ã…Â¸Ã‚ÂÃ‚Âª Multi-boutiques",
      "ÃƒÂ°Ã…Â¸ââ‚¬ËœÃ‚Â¥ Utilisateurs illimites",
      "ÃƒÂ°Ã…Â¸ââ‚¬ÂÃ…â€™ Acces API complet",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã…â€œ Historique illimite",
      "ÃƒÂ°Ã…Â¸Ã…Â½Ã‚Â Account manager dedie",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã…Â¾ Support telephonique",
      "ÃƒÂ°Ã…Â¸Ã…Â½ââ‚¬Å“ Onboarding personnalise",
      "ÃƒÂ°Ã…Â¸ââ‚¬Å“Ã…Â  SLA garanti 99.9%",
    ],
