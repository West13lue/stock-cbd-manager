...
var I18N = {
  ...
  translations: {
    fr: {
      ...
      "inventory.newSession": "Nouvelle session",
      "inventory.noSessions": "Aucune session",
      "inventory.noSessionsDesc": "Creez votre premiere session d'inventaire.",
      "inventory.sessionName": "Nom de la session",
      "inventory.scope": "Perimetre",
      "inventory.scopeAll": "Tous les produits",
      "inventory.scopeCategory": "Par categorie",
      "inventory.countingMode": "Mode de comptage",
      "inventory.modeTotal": "Stock total uniquement",
      "inventory.modeVariants": "Par variantes",
      ...
      "inventory.diffs": "Ecarts",
      "inventory.diffValue": "Valeur ecart",
      "inventory.start": "Demarrer",
      "inventory.validate": "Valider",
      "inventory.apply": "Appliquer",
      "inventory.counting": "Comptage",
      "inventory.review": "Validation",
      "inventory.history": "Historique",
      "inventory.expected": "Attendu",
      "inventory.counted": "Compte",
      "inventory.delta": "Ecart",
      "inventory.reason": "Raison",
      "inventory.reasonBreakage": "Casse",
      "inventory.reasonTheft": "Vol",
      "inventory.reasonError": "Erreur saisie",
      "inventory.reasonSampling": "Echantillon",
      "inventory.reasonExpired": "Perime",
      "inventory.reasonOther": "Autre",
      
      // Forecast
      "forecast.title": "Previsions",
      "forecast.subtitle": "Anticipez vos ruptures de stock",
      ...
      "forecast.statusOk": "OK",
      "forecast.statusWatch": "A surveiller",
      "forecast.statusUrgent": "Urgent",
      "forecast.statusCritical": "Critique",
      "forecast.statusOut": "Rupture",
      "forecast.statusNodata": "Sans donnees",
      "forecast.statusOverstock": "Surstock",
      "forecast.product": "Produit",
      "forecast.stock": "Stock",
      "forecast.avgSales": "Ventes moy.",
      "forecast.coverage": "Couverture",
      "forecast.stockoutEst": "Rupture est.",
      "forecast.reorder": "A commander",
      "forecast.status": "Statut",
      "forecast.scenarioPessimistic": "Pessimiste",
    ...
    en: {
      ...
      "inventory.newSession": "New session",
      "inventory.noSessions": "No sessions",
      "inventory.noSessionsDesc": "Create your first inventory session.",
      "inventory.sessionName": "Session name",
      "inventory.scope": "Scope",
      "inventory.scopeAll": "All products",
      "inventory.scopeCategory": "By category",
      "inventory.countingMode": "Counting mode",
      "inventory.modeTotal": "Total stock only",
      "inventory.modeVariants": "By variants",
      ...
      "inventory.diffs": "Differences",
      "inventory.diffValue": "Diff value",
      "inventory.start": "Start",
      "inventory.validate": "Validate",
      ...
      "inventory.counted": "Counted",
      "inventory.delta": "Delta",
      "inventory.reason": "Reason",
      "inventory.reasonBreakage": "Breakage",
      "inventory.reasonTheft": "Theft",
      "inventory.reasonError": "Input error",
      "inventory.reasonSampling": "Sampling",
      "inventory.reasonExpired": "Expired",
      "inventory.reasonOther": "Other",
      
      // Forecast
      "forecast.title": "Forecast",
      "forecast.subtitle": "Anticipate your stock shortages",
      ...
      "forecast.statusOk": "OK",
      "forecast.statusWatch": "Watch",
      "forecast.statusUrgent": "Urgent",
      "forecast.statusCritical": "Critical",
      "forecast.statusOut": "Out of stock",
      "forecast.statusNodata": "No data",
      "forecast.statusOverstock": "Overstock",
      "forecast.product": "Product",
      "forecast.stock": "Stock",
      "forecast.avgSales": "Avg sales",
      "forecast.coverage": "Coverage",
      "forecast.stockoutEst": "Stockout est.",
      "forecast.reorder": "To order",
      "forecast.status": "Status",
      "forecast.scenarioPessimistic": "Pessimistic",
      "forecast.scenarioNormal": "Normal",
