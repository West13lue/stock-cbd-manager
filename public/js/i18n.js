...
(function() {
  ...
  var translations = {
    fr: {
      ...
      "settings.inAppNotifications": "Notifications internes",
      "settings.externalChannels": "Canaux externes",
      "settings.externalChannelsDesc": "Recevez les alertes sur vos applications favorites",
      "settings.configured": "Configure",
      "settings.notConfigured": "Non configure",
      "settings.enabled": "Activer",
      "settings.webhookUrl": "URL du Webhook",
      "settings.discordHelp": "Creez un webhook dans les parametres de votre canal Discord > Integrations > Webhooks",
      "settings.slackHelp": "Creez une app Slack puis ajoutez un Incoming Webhook",
      "settings.botToken": "Token du Bot",
      "settings.chatId": "Chat ID",
      "settings.telegramBotHelp": "Creez un bot avec @BotFather sur Telegram",
      "settings.telegramChatHelp": "Utilisez @userinfobot pour obtenir votre Chat ID",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Choisissez un nom unique. Installez l'app Ntfy et abonnez-vous au meme topic.",
      "settings.server": "Serveur",
      "settings.optional": "optionnel",
      "settings.testNotifications": "Tester les notifications",
      "settings.channelSaved": "Canal configure",
      "settings.sendingTest": "Envoi du test...",
      "settings.testSuccess": "Test envoye avec succes!",
      "settings.testFailed": "Echec du test",
      "settings.noActiveChannels": "Aucun canal actif a tester",
      "settings.testingChannels": "Test des canaux en cours...",
      "settings.testSentTo": "Test envoye a",
      "settings.testPartialFail": "Certains tests ont echoue",
      "msg.webhookRequired": "URL du webhook requise",
      "msg.telegramConfigRequired": "Token et Chat ID requis",
      "msg.topicRequired": "Topic requis",
      "msg.unknownChannel": "Canal inconnu",
    ...
    en: {
      ...
      "settings.externalChannels": "External channels",
      "settings.externalChannelsDesc": "Receive alerts on your favorite apps",
      "settings.configured": "Configured",
      "settings.notConfigured": "Not configured",
      "settings.enabled": "Enable",
      "settings.webhookUrl": "Webhook URL",
      "settings.discordHelp": "Create a webhook in your Discord channel settings > Integrations > Webhooks",
      "settings.slackHelp": "Create a Slack app then add an Incoming Webhook",
      "settings.botToken": "Bot Token",
      "settings.chatId": "Chat ID",
      "settings.telegramBotHelp": "Create a bot with @BotFather on Telegram",
      "settings.telegramChatHelp": "Use @userinfobot to get your Chat ID",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Choose a unique name. Install the Ntfy app and subscribe to the same topic.",
      "settings.server": "Server",
      "settings.optional": "optional",
      "settings.testNotifications": "Test notifications",
      "settings.channelSaved": "Channel configured",
      "settings.sendingTest": "Sending test...",
      "settings.testSuccess": "Test sent successfully!",
      "settings.testFailed": "Test failed",
      "settings.noActiveChannels": "No active channel to test",
      "settings.testingChannels": "Testing channels...",
      "settings.testSentTo": "Test sent to",
      "settings.testPartialFail": "Some tests failed",
      "msg.webhookRequired": "Webhook URL required",
      "msg.telegramConfigRequired": "Token and Chat ID required",
      "msg.topicRequired": "Topic required",
      "msg.unknownChannel": "Unknown channel",
    ...
    de: {
      ...
      "settings.viewTutorials": "View tutorials",
      "settings.weightUnit": "Weight unit",
      "settings.inAppNotifications": "Interne Benachrichtigungen",
      "settings.externalChannels": "Externe Kanale",
      "settings.externalChannelsDesc": "Erhalten Sie Benachrichtigungen auf Ihren Lieblings-Apps",
      "settings.configured": "Konfiguriert",
      "settings.notConfigured": "Nicht konfiguriert",
      "settings.enabled": "Aktivieren",
      "settings.webhookUrl": "Webhook-URL",
      "settings.discordHelp": "Erstellen Sie einen Webhook in Ihren Discord-Kanaleinstellungen > Integrationen > Webhooks",
      "settings.slackHelp": "Erstellen Sie eine Slack-App und fugen Sie einen Incoming Webhook hinzu",
      "settings.botToken": "Bot-Token",
      "settings.chatId": "Chat-ID",
      "settings.telegramBotHelp": "Erstellen Sie einen Bot mit @BotFather auf Telegram",
      "settings.telegramChatHelp": "Verwenden Sie @userinfobot um Ihre Chat-ID zu erhalten",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Wahlen Sie einen eindeutigen Namen. Installieren Sie die Ntfy-App und abonnieren Sie dasselbe Topic.",
      "settings.server": "Server",
      "settings.optional": "optional",
      "settings.testNotifications": "Benachrichtigungen testen",
      "settings.channelSaved": "Kanal konfiguriert",
      "settings.sendingTest": "Test wird gesendet...",
      "settings.testSuccess": "Test erfolgreich gesendet!",
      "settings.testFailed": "Test fehlgeschlagen",
      "settings.noActiveChannels": "Kein aktiver Kanal zum Testen",
      "settings.testingChannels": "Kanale werden getestet...",
      "settings.testSentTo": "Test gesendet an",
      "settings.testPartialFail": "Einige Tests sind fehlgeschlagen",
      "msg.webhookRequired": "Webhook-URL erforderlich",
      "msg.telegramConfigRequired": "Token und Chat-ID erforderlich",
      "msg.topicRequired": "Topic erforderlich",
      "msg.unknownChannel": "Unbekannter Kanal",
      "shortcuts.closeModal": "Close window",
      "shortcuts.dashboard": "Dashboard",
      "shortcuts.help": "Show this help",
      "shortcuts.newProduct": "New product",
    ...
    es: {
      ...
      "settings.viewTutorials": "View tutorials",
      "settings.weightUnit": "Weight unit",
      "settings.inAppNotifications": "Notificaciones internas",
      "settings.externalChannels": "Canales externos",
      "settings.externalChannelsDesc": "Recibe alertas en tus aplicaciones favoritas",
      "settings.configured": "Configurado",
      "settings.notConfigured": "No configurado",
      "settings.enabled": "Activar",
      "settings.webhookUrl": "URL del Webhook",
      "settings.discordHelp": "Crea un webhook en la configuracion de tu canal Discord > Integraciones > Webhooks",
      "settings.slackHelp": "Crea una app de Slack y anade un Incoming Webhook",
      "settings.botToken": "Token del Bot",
      "settings.chatId": "Chat ID",
      "settings.telegramBotHelp": "Crea un bot con @BotFather en Telegram",
      "settings.telegramChatHelp": "Usa @userinfobot para obtener tu Chat ID",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Elige un nombre unico. Instala la app Ntfy y suscribete al mismo topic.",
      "settings.server": "Servidor",
      "settings.optional": "opcional",
      "settings.testNotifications": "Probar notificaciones",
      "settings.channelSaved": "Canal configurado",
      "settings.sendingTest": "Enviando prueba...",
      "settings.testSuccess": "Prueba enviada con exito!",
      "settings.testFailed": "Prueba fallida",
      "settings.noActiveChannels": "Ningun canal activo para probar",
      "settings.testingChannels": "Probando canales...",
      "settings.testSentTo": "Prueba enviada a",
      "settings.testPartialFail": "Algunas pruebas fallaron",
      "msg.webhookRequired": "URL del webhook requerida",
      "msg.telegramConfigRequired": "Token y Chat ID requeridos",
      "msg.topicRequired": "Topic requerido",
      "msg.unknownChannel": "Canal desconocido",
      "shortcuts.closeModal": "Close window",
      "shortcuts.dashboard": "Dashboard",
      "shortcuts.help": "Show this help",
      "shortcuts.newProduct": "New product",
    ...
    it: {
      ...
      "settings.viewTutorials": "View tutorials",
      "settings.weightUnit": "Weight unit",
      "settings.inAppNotifications": "Notifiche interne",
      "settings.externalChannels": "Canali esterni",
      "settings.externalChannelsDesc": "Ricevi avvisi sulle tue app preferite",
      "settings.configured": "Configurato",
      "settings.notConfigured": "Non configurato",
      "settings.enabled": "Attiva",
      "settings.webhookUrl": "URL Webhook",
      "settings.discordHelp": "Crea un webhook nelle impostazioni del canale Discord > Integrazioni > Webhooks",
      "settings.slackHelp": "Crea un'app Slack e aggiungi un Incoming Webhook",
      "settings.botToken": "Token Bot",
      "settings.chatId": "Chat ID",
      "settings.telegramBotHelp": "Crea un bot con @BotFather su Telegram",
      "settings.telegramChatHelp": "Usa @userinfobot per ottenere il tuo Chat ID",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Scegli un nome unico. Installa l'app Ntfy e iscriviti allo stesso topic.",
      "settings.server": "Server",
      "settings.optional": "opzionale",
      "settings.testNotifications": "Testa notifiche",
      "settings.channelSaved": "Canale configurato",
      "settings.sendingTest": "Invio test...",
      "settings.testSuccess": "Test inviato con successo!",
      "settings.testFailed": "Test fallito",
      "settings.noActiveChannels": "Nessun canale attivo da testare",
      "settings.testingChannels": "Test dei canali...",
      "settings.testSentTo": "Test inviato a",
      "settings.testPartialFail": "Alcuni test sono falliti",
      "msg.webhookRequired": "URL webhook richiesto",
      "msg.telegramConfigRequired": "Token e Chat ID richiesti",
      "msg.topicRequired": "Topic richiesto",
      "msg.unknownChannel": "Canale sconosciuto",
      "shortcuts.closeModal": "Close window",
      "shortcuts.dashboard": "Dashboard",
      "shortcuts.help": "Show this help",
      "shortcuts.newProduct": "New product",
    ...
    pt: {
      ...
      "settings.inAppNotifications": "Notificacoes internas",
      "settings.externalChannels": "Canais externos",
      "settings.externalChannelsDesc": "Receba alertas nos seus aplicativos favoritos",
      "settings.configured": "Configurado",
      "settings.notConfigured": "Nao configurado",
      "settings.enabled": "Ativar",
      "settings.webhookUrl": "URL do Webhook",
      "settings.discordHelp": "Crie um webhook nas configuracoes do seu canal Discord > Integracoes > Webhooks",
      "settings.slackHelp": "Crie um app Slack e adicione um Incoming Webhook",
      "settings.botToken": "Token do Bot",
      "settings.chatId": "Chat ID",
      "settings.telegramBotHelp": "Crie um bot com @BotFather no Telegram",
      "settings.telegramChatHelp": "Use @userinfobot para obter seu Chat ID",
      "settings.topic": "Topic",
      "settings.ntfyHelp": "Escolha um nome unico. Instale o app Ntfy e inscreva-se no mesmo topic.",
      "settings.server": "Servidor",
      "settings.optional": "opcional",
      "settings.testNotifications": "Testar notificacoes",
      "settings.channelSaved": "Canal configurado",
      "settings.sendingTest": "Enviando teste...",
      "settings.testSuccess": "Teste enviado com sucesso!",
      "settings.testFailed": "Teste falhou",
      "settings.noActiveChannels": "Nenhum canal ativo para testar",
      "settings.testingChannels": "Testando canais...",
      "settings.testSentTo": "Teste enviado para",
      "settings.testPartialFail": "Alguns testes falharam",
      "msg.webhookRequired": "URL do webhook obrigatoria",
      "msg.telegramConfigRequired": "Token e Chat ID obrigatorios",
      "msg.topicRequired": "Topic obrigatorio",
      "msg.unknownChannel": "Canal desconhecido",
      "shortcuts.closeModal": "Close window",
      "shortcuts.dashboard": "Dashboard",
      "shortcuts.help": "Show this help",
      "shortcuts.newProduct": "New product",
